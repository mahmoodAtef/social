            ...
            appBar: AppBar(
              ...
              actions: [
               TextButton (
                 ...
                 {
                   isLoading = true;
                   Fluttertoast.showToast(msg: 'Please wait .. don\'t close this page' ,
                       toastLength: Toast.LENGTH_LONG);
                   if (cover != null){
                     await AppCubit.get(context).uploadCover().then((value)  {
                       model.cover = AppCubit.get(context).coverUrl;
                       print('new cover : ${model.cover}');
                     });
                   }
                 if (profile != null){
                   await AppCubit.get(context).uploadProfile().then((value) {
                     model.image = AppCubit.get(context).profileUrl;
                     print ('new profile' +model.image.toString());
                   });
                 }
                await  AppCubit.get(context).updateUser(userModel: model, context: context).then((value) {
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: Colors.grey,
                                        image: cover == null ? DecorationImage(
                                            image:  NetworkImage(
                                              '${model.cover}',
                                            ),
